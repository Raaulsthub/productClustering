...
titlematch = StringMatch(['Bann Catr kg', 'Bisc Baudc 150g', 'MOLH TOM PALADORI SACH 340 un ', 
'MAIONESE HEINZ TRAD SQ390G un', 'ERVA MATE MADRUGADA un',
'VINAGRE PRINZ 750ML VINHO BRANCO un', 'CARVAO ACACIA NEGRA FOGONERO3KG un',
'LEITE UHT SEMI DESN'], productList2)
titlematch.tokenize()
